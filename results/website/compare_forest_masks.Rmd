...
**FNEWS (Copernicus HRL 2015+2018)**

Für das Fernerkundungsbasierte Nationale Erfassungssytem Waldschäden (FNEWS) wurde basierend auf den Gehölzmasken der Copernicus High Resolution Layer Forest 2015 und 2018 eine Waldmaske erstellt. Die genauere Version aus 2018 wurde dabei mit der Version aus 2015 ergänzt um schadbedingte Kahlflächen der Jahre 2015 bis 2018 dem Wald zuzuordnen (Minimum Mapping Unit 0.25 ha).
...
comparison_table_bwi %>%
  mutate(Waldmaske = case_when(Waldmaske == "basis_dlm" ~ "Basis-DLM",
                               ...
                               Waldmaske == "fnews" ~ "FNEWS (HRL 2015+2018)",
...
##### FNEWS
```{r plot_lucas_fnews, fig.cap= "Unterschiede zwischen LUCAS und FNEWs (HRL 2015+2018)"}

ref_comp_lucas %>% mutate(wald = ifelse(lucas=="1" & fnews == "0", "nur LUCAS",
                                        ifelse(lucas=="0" & fnews =="1", "nur FNEWS",
                                               ifelse(lucas=="0" & fnews =="0", "kein Wald", "Wald")))) %>%
  select(lucas, fnews, wald) %>%
  filter(wald == "Wald") %>%
...
<img src=https://raw.githubusercontent.com/wiesehahn/waldmaske/master/results/figures/comparison/forest-mask_10kmN573E55_fnews.jpeg width="500" />
...
<img src=https://raw.githubusercontent.com/wiesehahn/waldmaske/master/results/figures/comparison/forest-mask_1kmN5735E557_fnews.jpeg width="500" />
...
<img src=https://raw.githubusercontent.com/wiesehahn/waldmaske/master/results/figures/comparison/forest-mask_1kmN5735E554_fnews.jpeg width="500" />
