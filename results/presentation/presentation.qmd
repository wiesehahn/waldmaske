...
::: {.r-stack}
[*Wo sind potenzielle Standorte für Windkraftanlagen?*]{.fragment .fade-in-then-out  fragment-index=1}

[*Veränderung des NDVI im Wald*]{.fragment .fade-in-then-out  fragment-index=2}

[*Google Maps, DTK, ...*]{.fragment .fade-in-then-out  fragment-index=3}

[*eher stichprobenbasiert*]{.fragment .fade-in-then-out  fragment-index=4}
:::
...
::: {.r-stack}
![](https://raw.githubusercontent.com/wiesehahn/waldmaske/master/resources/figures/treespecies_edgeeffect_ortho_solling.jpeg){width=1200 fragment-index=1}

![](https://raw.githubusercontent.com/wiesehahn/waldmaske/master/resources/figures/treespecies_edgeeffect_probability_solling.jpeg){.fragment width=1200 fragment-index=2}

![](https://raw.githubusercontent.com/wiesehahn/waldmaske/master/resources/figures/treespecies_edgeeffect_species_solling.jpeg){.fragment width=1200 fragment-index=3}
:::
...
::: {.r-stack}
[*soll nur auf Bereiche mit Bäumen angewendet werden*]{.fragment .fade-in-then-out fragment-index=1}

[*Unsicherheit in Rand- und Offenbereichen am größten*]{.fragment .fade-in-then-out  fragment-index=2}

[*führt zu falscher Klassifizierung*]{.fragment .fade-in-then-out  fragment-index=3}
:::
...
::: {.r-stack}
*Ausmaskieren alter Schäden und unbestockter Flächen*
:::
...
- Open Data
- Online über moderne Schnittstellen als Vektordatensatz abrufbar
:::
::::
...
In der Flur oder im bebauten Gebiet gelegene [kleinere Flächen mit einzelnen Baumgruppen]{.highlight1}.
:::
::::
...
In der Flur oder im bebauten Gebiet gelegene bestockte [Flächen unter 1.000 m², Gehölzstreifen unter 10 m Breite und (...) Parkanlagen sind nicht Wald im Sinne der BWI]{.highlight1}.
:::
::::
...
::: {.attribution}
Tabelle: [AWF-Wiki](http://wiki.awf.forst.uni-goettingen.de)
:::
...
::: {.attribution}
Tabelle: [AWF-Wiki](http://wiki.awf.forst.uni-goettingen.de) ([EFI Technichl Report](https://efi.int/sites/default/files/files/publication-bank/2018/tr_88_annex1.pdf))
:::
...
# Interaktive Karten {visibility="uncounted"}
